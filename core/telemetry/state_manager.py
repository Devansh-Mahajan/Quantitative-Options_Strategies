        ...
        for short_leg in shorts:
            if short_leg['type'] == 'P':
                ...
                if matching_long:
                    ...
                    # Naked short call: true max loss is unbounded (underlying can rally
                    # indefinitely). Use the same bounded heuristic as naked puts (strike
                    # value as a stand-in for worst case) so this isn't silently zero-risk.
                    risk += (short_leg['strike'] * 100) * short_leg['qty']
