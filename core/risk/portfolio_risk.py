"""
Options/Alpaca-stack portfolio risk engine (legs-aware Monte Carlo VaR/CVaR for
options positions). Not the same engine as risk.portfolio_risk, which is the
simpler crypto/Binance-stack engine used by bot/orchestrator.py — both are live,
serving different trading stacks under the same class name (PortfolioRiskEngine).
"""
...
from core.ml.quant_models import black_scholes_price
from core.telemetry.system_telemetry import DEFAULT_PORTFOLIO_RISK_GUARD_SNAPSHOT_PATH, write_risk_snapshot
